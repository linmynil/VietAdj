...
namespace triluatsoft.tls.Web.Bundling
{
    public static class ScriptPaths
    {
        ...
        public const string InputMask = "~/Scripts/inputmask/inputmask.min.js";
        public const string JQuery_InputMask = "~/Scripts/inputmask/jquery.inputmask.min.js";
        public const string InputMask_Extensions = "~/Scripts/inputmask/inputmask.extensions.js";
        public const string InputMask_Extensions_Date = "~/Scripts/inputmask/inputmask.date.extensions.js";
        public const string InputMask_DependencyLib = "~/Scripts/inputmask/dependencyLibs/inputmask.dependencyLib.js";
        ...
        public const string Bootstrap_DateTimePicker = "~/libs/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js";//SPA!
        public const string Bootstrap_TwoSideMultiSelect = "~/libs/two-side-multi-select/multiselect.min.js";//SPA!
