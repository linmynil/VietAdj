(function () {
    appModule.controller('tenant.views.OldList.viewExpensesReport', [
        '$scope',
        '$uibModal', '$window',
        ...
        function (
            ...
            vm.viewReport = function (timesheetID, type, lang) {
                console.log('viewReport', timesheetID, type, lang);

                var url = 'report/timesheetExpenseReport?tsID=' + timesheetID + '&type=' +type + '&lang=' + lang;
                $window.open(url, "popup", "width=850,height=700,left=100,top=100");
            };

            vm.exportExcel = function (event, timesheetID, empID, lang) {
                event.preventDefault();
                console.log('exportExcel', timesheetID, empID, lang);
                if (empID === undefined) {
                ...
                reportService.exportTimesheetFeeReport(timesheetID, empID, lang)
                    .then(function (result) {
