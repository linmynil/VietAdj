...
namespace triluatsoft.tls.Web.Controllers
{
    public class AccountController : tlsControllerBase
    {
        ...
        public virtual async Task<JsonResult> Login(LoginViewModel loginModel, string returnUrl = "", string returnUrlHash = "")
        {
            ...
            {
                Logger.Error("AccountController.Login " + e);
                UserFriendlyException ee = (UserFriendlyException)e;
                ErrorInfo error = new ErrorInfo(ee.Code, ee.Details);
                return Json(new AjaxResponse { TargetUrl = returnUrl, Error = error, Success = false });
            }
        ...
        [ChildActionOnly]
        public PartialViewResult AppLogo(string appPath, int width = 285, int height = 187)
        {
            ViewBag.TenantCustomLogoWidth = 285;
            ViewBag.TenantCustomLogoHeight = 187;
