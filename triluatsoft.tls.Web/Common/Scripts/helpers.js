...
(function () {
    ...
    var isAdmin = abp.services.app.dashBoard.isAdminCurrentUser();
    ...
    app.createDateRangePickerOptions = function () {
        var options = {
            ...
            min: isAdmin ? moment('2000-01-01') : moment('2017-01-01'),
            minDate: isAdmin ? moment('2000-01-01') : moment('2017-01-01'),
            max: moment(),
            maxDate: moment(),
            ranges: {}
        };
