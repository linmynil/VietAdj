    ...
    appModule.controller('common.views.users.createOrEditModal', [
        ...
        function ($scope, $uibModalInstance, userService, userId) {
            ...
            vm.save = function () {
                ...
                vm.user.dateOfBirth = new Date(vm.user.birthday);
            ...
            function init() {
                userService.getUserForEdit({
                    ...
                    //vm.user.surname = "abc";
                    //vm.user.birthday = new Date(vm.user.dateOfBirth);
                    //console.log('birday: ', vm.user.dateOfBirth);
                    //var newday = new Date(vm.user.birthday);
                    //vm.user.birthday = newday;
                    //console.log('sadfdsf', newday);
