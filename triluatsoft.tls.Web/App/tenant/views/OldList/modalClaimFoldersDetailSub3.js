(function () {
    appModule.controller('tenant.views.OldList.modalClaimFoldersDetailSub3', [
        '$scope',
        '$uibModalInstance',
        '$uibModal',
        ...
        function (
            ...
            vm.openModalClaimFolder = function (temp) {                
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/tenant/views/OldList/modalClaimFoldersDetailSub3.cshtml',
                    controller: 'tenant.views.OldList.modalClaimFoldersDetailSub3 as vm',
                    backdrop: 'static',
                    size: 'lg',
                    resolve: {
                        item: function () {
