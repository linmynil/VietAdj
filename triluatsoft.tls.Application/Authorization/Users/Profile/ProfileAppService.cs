...
namespace triluatsoft.tls.Authorization.Users.Profile
{
    ...
    public class ProfileAppService : tlsAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            if (userProfileEditDto.DateOfBirth != null)
            {
                userProfileEditDto.Birthday = userProfileEditDto.DateOfBirth.Value.Day + "/" + userProfileEditDto.DateOfBirth.Value.Month + "/" + userProfileEditDto.DateOfBirth.Value.Year;
            }
        ...
        public async Task UpdateCurrentUserProfile(CurrentUserProfileEditDto input)
        {
            ...
            string[] dtsa = input.Birthday.Split("/");
