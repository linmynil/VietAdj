(function () {
    ...
    appModule.controller('common.views.users.index', [
        '$scope', '$uibModal', '$stateParams', 'uiGridConstants', 'abp.services.app.user', 'abp.services.app.oldUser',
        function ($scope, $uibModal, $stateParams, uiGridConstants, userService, oldUserService) {
            var vm = this;
            ...
            vm.migrateUsers = function () {
                console.log('Migration old user to new table');
                oldUserService.migrateOldUsers()
                .then(function (result) {
