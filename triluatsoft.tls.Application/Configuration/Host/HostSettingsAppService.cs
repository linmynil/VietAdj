...
namespace triluatsoft.tls.Configuration.Host
{
    ...
    public class HostSettingsAppService : tlsAppServiceBase, IHostSettingsAppService
    {
        ...
        {
            VAJMailList testlist = new VAJMailList();
            testlist.toList.Add(input.EmailAddress);
            //List<string> to = new List<string>();
            //to.Add(input.EmailAddress);            
            //await _emailSenderVAJ.SendAsync(
            //    to,
            //    L("TestEmail_Subject"),
            //    L("TestEmail_Body")
            //);
            await _emailSenderVAJ.SendClaimConfirm("82.17.HN", "ABC Insurer", "2020-08-03", testlist);
        }

        public string SendCheckEmail(SendTestEmailInput input)
        {
            List<string> to = new List<string>();
            to.Add(input.EmailAddress);
            //_emailSenderVAJ.SendClaimConfirm("18.26.SG", "Test Insured", "15:30, 21-03-2018", to, to);
            //_emailSenderVAJ.SendClaimConfirmRemind("18.26.SG", "Test Insured", "15:30, 21-03-2018", "2", to);
            return "OK";
        }
        #endregion
    }
